...
public class HandsetFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mApplication = (SpydroidApplication) requireActivity().getApplication();
    }
    ...
    public void onPause() {
        super.onPause();
        update();
        requireActivity().unregisterReceiver(mWifiStateReceiver);
    ...
    public void onResume() {
        ...
        requireActivity().registerReceiver(mWifiStateReceiver, new IntentFilter(WifiManager.NETWORK_STATE_CHANGED_ACTION));
    }
